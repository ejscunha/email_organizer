defmodule EmailOrganizer.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      EmailOrganizer.Repo,
      {DNSCluster, query: Application.get_env(:email_organizer, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: EmailOrganizer.PubSub},
      # Start a worker by calling: EmailOrganizer.Worker.start_link(arg)
      # {EmailOrganizer.Worker, arg},
